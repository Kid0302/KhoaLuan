...
VALUES 
    (1, 1, 1, N'Sản phẩm lỗi do sản xuất'),
    (2, 2, 1, N'Sản phẩm không đúng mẫu mã'),
    (3, 3, 1, N'Sản phẩm không đúng màu sắc'),
    (4, 4, 1, N'Sản phẩm không đúng kích cỡ'),
    (5, 5, 1, N'Sản phẩm không đúng chất lượng');
Go
---------------------------------------------------------------------
